## FUNZIONE CHE EFFETTUA DEI CONFRONTI RISPETTO AD UN ELENCO DI CONTRASTI E CORREGGE RISPETTO AI CONTRASTI EFFETTIVAMENTE EFFETTUATI. i contrasti vanno specificati come lista come nell'esempio di seguito.


#contr=list(list(c("PMong_PZ_giovani"),c("PMong_PZ_anziani")),list(c("PMong_FZ_giovani"), c("PMong_FZ_anziani")))

t.test.pairs<-function(dat, vars, contr, dep, wid, p.adjust.methods="none", paired=F, type="t.test", vars.bet=NULL,...){
