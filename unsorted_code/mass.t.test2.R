...
library(erpR)
data(ERPsets)	
base1="Exp1_word_subj"
base2="Exp1_nonword_subj"
numbers1=1:20
numbers2=1:20
startmsec=-200
endmsec=1500
...
mass.t.test2<-function(base1=NULL, base2=NULL, numbers1=NULL, numbers2=numbers1, startmsec=NULL, endmsec=NULL, paired=F, erplist1=NULL, erplist2=erplist1,  electrodes="all", to.exclude=NULL, interval=c(startmsec, endmsec), p.adjust.method="none", n.permutations=1000) {
