...
# wit= nomi dei livelli in cui fare i contrasti in questa forma 
# 
# coeff.bet= è un argomento temporaneo: permette di sceg
# è importante che l'ordine dei livelli specificati in wit1 e wit2 rispecchi l'ordine.c("var1_var2"), c("var2_var3")

				


contrm=function(dep, subj , wit ,bet, wit1,wit2,bet1, bet2, dati, coeff.bet=NULL) {
