...
# contr= nomi dei livelli in cui fare i contrasti in questa forma c("var1_var2"), c("var2_var3"), è 
# coeff.bet= è un argomento temporaneo: permette di sceg
# importante che l'ordine dei livelli specificati in wit1 e wit2 rispecchi l'ordine.

				


contrm.matrix=function(dep, subj , wit ,bet, dati, corr=FALSE) {
